            ...
            <View
                ...
                <ScrollView>
                    <View style={styles.border}>
                        ...
                        <Image style={styles.img} source={require('../../../../asserts/images/Vline.png')}></Image>
                        ...
                        <Text style={styles.contents}>
                            2、因违反用户协议被封禁的用户，可以自行与客户端联系。其中，被实施功能封禁的用户会在封禁期届满后自动恢复被封禁功能。被封禁用户可提交申诉，客户端将对申诉进行审查，并自行合理判断决定是否变更处罚措施。                 </Text>
                        <Text style={styles.contents}>
