...
class Index extends Component {
  ...
  render() {
    const {myOrderNum,awaitPayNum,payingNum,commentNumv,serviceNum} = this.state;
    return (
      <View style={{ flex: 1 }}>
        <View style={styles.head_bg}>
          <TouchableOpacity>
            <View style={styles.section1_NamePhotoBorder}>
              <Image style={styles.photo} source={{ uri: 'https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=384029267,1578774283&fm=26&gp=0.jpg' }}></Image>
          ...
          <View style={styles.mySaleBorder}>
            <View style={styles.ItemIcon}>
              <TouchableOpacity style={{
                ...
                />
                <Text style={styles.ItemiconText2}>
                  我的订单
              </Text>
              </TouchableOpacity>
            </View>
        ...
        <View>
          ...
          <View style={{ paddingBottom: pxToDp(0) }}>
            <DemandList type={1} text="哈哈哈哈哈哈哈阿斯顿萨达萨达萨达萨达萨达萨达萨达撒" date="2021-02-11"></DemandList>
            <DemandList type={1} text="哈哈哈哈哈哈哈阿斯顿萨达萨达萨达萨达萨达萨达萨达撒" date="2021-02-11"></DemandList>
          </View>
          {/* </ScrollView> */}
        </View>
