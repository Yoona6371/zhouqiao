        ...
        top3: [
            {
                champion_name: '新新',
                champion_hot: '9999',
                champion_photo: 'https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=2346571852,1188167565&fm=26&gp=0.jpg'
            },
            {
                runner_up_name: '宝儿',
                runner_up_hot: '4563',
                runner_up_photo: 'https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=2134570287,410543358&fm=26&gp=0.jpg'
            },
            {
                third_place_name: '臭臭',
                third_place_hot: '1344',
                third_place_photo: 'https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=2756218779,3874031744&fm=26&gp=0.jpg'
            }
        ]
    }
    render() {
        ...
        return (
            <View style={{ flex: 1 }}>
                <View style={{ position: 'absolute', top: 0, zIndex: 999 }}>
                    <TopTitle returnBack={() => alert('111')} title="设计师榜" showBtn={false} color="#FFF" bgColor=""></TopTitle>
                </View>
                <RankCardTop3
